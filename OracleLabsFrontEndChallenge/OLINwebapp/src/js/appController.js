     ...
     function ControllerViewModel() {
      ...
      self.mdScreen = ResponsiveKnockoutUtils.createMediaQueryObservable(mdQuery);
       ...
       self.router.configure({
         'workspace': {label: 'Workspace', isDefault: true},
       });
      ...
      self.appName = ko.observable("Olin - Oracle Labs Interactive Notebook");
      // User Info used in Global Navigation area
      self.userLogin = ko.observable("elharrougui0@gmail.com");
